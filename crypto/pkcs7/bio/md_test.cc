...
class BIOMdTest : public testing::TestWithParam<MessageDigestParams> {};

INSTANTIATE_TEST_SUITE_P(
    PKCS7Test, BIOMdTest, testing::ValuesIn(MessageDigests),
    [](const testing::TestParamInfo<MessageDigestParams> &params)
        -> std::string { return params.param.name; });

TEST_P(BIOMdTest, MessageDigestBasic) {
...
TEST_P(BIOMdTest, MessageDigestRandomized) {
